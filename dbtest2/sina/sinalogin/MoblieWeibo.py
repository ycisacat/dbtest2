...
headers = {
    # "Referer":'http://login.weibo.cn/login/?ns=1&revalid=2&backURL=http%3A%2F%2Fweibo.cn%2F%3Fluicode%3D20000057%26lfid%3D102803&backTitle=%CE%A2%B2%A9&vt=',
...
class MoblieWeibo:
    ...
    def getHostUrl(self):
        ...
        UrlLoginRequest=urllib2.Request(HostUrl,headers=headers)
    ...
    def getArgs(self):
        ...
        self.getHostUrl()
        ArgsRequest=urllib2.Request(self.HostUrl,headers=headers)
...
m=MoblieWeibo()
m.login("18819423747","xie5321927")
