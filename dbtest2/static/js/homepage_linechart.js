 $(document).ready(function() 
            ...
            { 
               type:'spline',
               name: '开心',
               data: [25, 19, 15, 13, 12, 9,9,10]
            },
                                     
            {
               type:'spline',
               name: '快乐',
               data: [16, 22, 18, 12, 11, 8,5,8]
            }, 
                           
            {
               type:'spline',
               name: '满意',
               data: [13, 18, 26, 22, 17, 11,11,4]
            }, 
                         
            {
               type:'spline',
               name: '惊讶',
               data: [6, 11, 18, 24, 15, 12,6,7]
            },
                         
            {
               type:'spline',
               name: '无奈',
               data: [2, 4.0, 7.9, 13.8, 17.2, 14.8,9,8]
            },
                           
            {
               type:'spline',
               name: '不满',
               data: [-1.4, 2.5,5.8, 9.2, 15.9, 22.7,2,5]
            },
                           
            {
               type:'spline',
               name: '难过',
               data: [-3.7, -0.8, 2.9, 7.6, 14.8, 22.3,21,23]
            },
                           
            {
               type:'spline',
               name: '痛恨',
               data: [0.6, 2.2,5.9, 9.7, 15.8, 17.7,16,19]
            }];    
